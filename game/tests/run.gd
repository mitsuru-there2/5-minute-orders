...
func _initialize() -> void:
	...
	var expected := [TurnPhase.Phase.LOCKED, TurnPhase.Phase.MOVEMENT,
		TurnPhase.Phase.COMBAT, TurnPhase.Phase.EVENTS,
		TurnPhase.Phase.RESULTS, TurnPhase.Phase.ORDERS]
